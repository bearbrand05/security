...
// Get all suppliers with their items grouped together
$sql = "SELECT 
          s.name_supplier,
          s.contact_name,
          s.category,
          s.ratings,
          s.review,
          GROUP_CONCAT(s.supply) AS supplies,
          MIN(s.id_supplier) AS id_supplier
        FROM supplier_table s
        WHERE s.name_supplier IN ('Supplier 1', 'Supplier 2', 'Supplier 3', 'Supplier 4', 'Supplier 5')
        GROUP BY s.name_supplier, s.contact_name, s.category, s.ratings, s.review";
            ...
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    <?php foreach ($result as $supplier): ?>
                        <?php
                        $matchingOrder = null;
                        $suppliedItems = explode(',', $supplier['supplies']);
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-section">
                                    ...
                                    <p><strong>Products:</strong> <?= htmlspecialchars($supplier['supplies']) ?></p>
